...
class Server:
    def __init__(self):
        ...
        self.server_ip = '192.168.20.39'#socket.gethostbyname(socket.gethostname())
    ...
    def handle_client(self, client_socket, addr):
        ...
        try:
            # Extract both the username and final_key from the returned tuple
            user, final_key = loginp.handle_login_server()
        ...
        # Now you can safely access the 'rootdir' of the user using the username
